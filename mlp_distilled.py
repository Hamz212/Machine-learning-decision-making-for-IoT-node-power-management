...
class MLPDistilled(DecisionMethod):
    ...
    def __init__(self):
        ...
        # 3 inputs (theta, v_batt, v_sc) → 8 hidden → 3 actions
    ...
    def train(self, env_factory):
        ...
        # 2) Generate a supervised dataset by sampling continuous states
